...
- **2026-07-13** – The first vector search after the collection had been idle (runtime Search OCU observed at 0.0 before the request) completed significantly slower than subsequent searches (observed: 16.69 s vs. 0.52–1.17 s). This behavior is consistent with a cold-start latency for search after idle.
